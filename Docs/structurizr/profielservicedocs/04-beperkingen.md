...
- Service-to-service-toegang verloopt via een API-gateway op basis van FSC (contracten) en FTV (tokens) uit het Federatief Datastelsel. Opgelegd door stelselafspraken. Impact: de Profiel Service implementeert geen eigen tokenvalidatie of scope-mapping; toegangsbeheer is een infrastructurele en contractuele zaak, niet een applicatiezaak. Zie [§09 Infrastructuur, Authenticatie en autorisatie](09-infrastructuur-architectuur.md#authenticatie-en-autorisatie) en de [bijlage Logging, Toegang en Doelbinding](../decisions/addendum/profiel-service-logging-en-toegang.md).
