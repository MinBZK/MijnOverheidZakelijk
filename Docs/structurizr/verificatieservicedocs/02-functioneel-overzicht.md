...
De aanroepende dienst krijgt een referentie id terug na het doen van een verificatieaanvraag.
...
6. Aanroepende dienst → Verificatie Service: Valideer code, met referentie id.
