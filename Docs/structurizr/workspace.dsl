workspace "Mijn Overheid Zakelijk" "Het model voor Mijn Overheid Zakelijk" {
    ...
    model {
        ...
        group "Logius" {
            ...
            NotificatieService = softwareSystem "Notificatiedienst" "Versturen van notificaties en contactherstel" {
                ...
                NMC = container "Notificatie Management Component" "Orchestreert notificaties en contactherstel" "" "MOZa, Nog te bouwen" {
                    ...
                    CentraleNotificatieController = component "CentraleNotificatieController" "Controller: intake op identificerend nummer (NMC resolvet)" "REST" "MOZa, Nog te bouwen"
                    DecentraleNotificatieController = component "DecentraleNotificatieController" "Controller: intake met reeds opgehaalde gegevens" "REST" "MOZa, Nog te bouwen"
        ...
        CentraleNotificatieController -> Orchestrator "Delegeert verzoek" ""
        DecentraleNotificatieController -> Orchestrator "Delegeert verzoek" ""
        ...
        Orchestrator -> NotificatieStatusCallbackAdapter "Koppelt notificatiestatus terug (optioneel)" ""
