...
docker/podman run -it --rm -p 8080:8080 -v C:/Users/Tijmen/Documents/moz/github/MijnOverheidZakelijk/Docs/structurizr:/usr/local/structurizr structurizr/lite
```
